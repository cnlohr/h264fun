all : testbase testbase.h264 128x128.h264 testdec testbase.mp4 testfile.mp4
...
clean :
	rm -rf testbase testbase.h264 128x128.h264 testdec testbase.mp4 testfile testfile.h264 testfile.mp4
